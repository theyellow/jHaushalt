...
public class FarbPaletten {
  ...
  public static Color getFarbe(int nr, String name) {
  	for(int i=0; i<paletten.length; i++)
  	  if(name.equalsIgnoreCase(palettenNamen[i])) {
  	    Color[] palette = paletten[i];
  ...
  public static int setCustomColor(Color[] farben) {
    fsCustom = farben;
    for(int i=0; i<paletten.length; i++)
  ...
  public static int setCustomColor(String farben) {
    StringTokenizer st = new StringTokenizer(farben, ",");
