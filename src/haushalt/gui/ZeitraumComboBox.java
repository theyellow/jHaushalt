...
import haushalt.daten.zeitraum.*;
...
public class ZeitraumComboBox extends JComboBox {
  ...
  public AbstractZeitraum getZeitraum(final String text) {
    switch(getSelectedIndex()) {
      case 0: return new Monat(text);
      case 1: return new Quartal(text);
      case 2: return new Halbjahr(text);
      case 3: return new Jahr(text);
      case 4: return new VollesJahrBisDatum(text);
      case 5: return new VollesJahrBisHeute(text);
      case 6: return new JahresanfangBisDatum(text);
      case 7: return new JahresanfangBisHeute(text);
      case 8: return new FreierZeitraum(text);
      case 9: return new MehrereJahre(text);
      case 10: return new AktuellerMonat(text);
      case 11: return new AktuellesQuartal(text);
      case 12: return new AktuellesJahr(text);
    }
    return null;
  }
}