...
public class DataServiceTest {
	...
	public void setup() {
		...
		datenbasisService = mock(DatenbasisService.class);
		when(datenbasisService.getDatenbasis()).thenReturn(datenbasis);
		
		service.setDatenbasisService(datenbasisService);
