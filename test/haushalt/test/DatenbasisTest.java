...
public class DatenbasisTest {
	...
	public void testFindeOderErzeugeRegister() {
		final Register reg1 = db.findeOderErzeugeRegister("Konto1");
		assertTrue("Das 1.Register sollte 'Konto1' sein.",
				reg1.toString().equals("Konto1"));
		final Register reg2 = db.findeOderErzeugeRegister("Konto2");
		assertTrue("Das 2.Register sollte 'Konto2' sein.",
				reg2.toString().equals("Konto2"));
		final Register reg3 = db.findeOderErzeugeRegister("Konto3");
		assertTrue("Das 3.Register sollte 'Konto3' sein.",
				reg3.toString().equals("Konto3"));
		final Register reg4 = db.findeOderErzeugeRegister("Konto1");
	...
	public void testAendereRegisterIndex() {
		...
		final String[] liste = db.getRegisterNamen();
	...
	public void testFindeOderErzeugeKategorieStringEinzelKategorie() {
		...
		final EinzelKategorie kat2 = db.findeOderErzeugeKategorie("MeineKategorie2");
		assertTrue("Die 2.Kategorie sollte 'MeineKategorie2' sein.",
				kat2.toString().equals("MeineKategorie2") && kat2.isHauptkategorie());
		final EinzelKategorie kat3 = db.findeOderErzeugeKategorie("MeineKategorie1:Unterkategorie");
		...
		final EinzelKategorie kat4 = db.findeOderErzeugeKategorie("MeineKategorie1");
	...
	public void testAddStandardBuchung() {
		final EinzelKategorie kat1 = db.findeOderErzeugeKategorie("MeineKategorie1");
		final StandardBuchung buchung1 = new StandardBuchung(
				new Datum(24, 4, 1971),
				"Testbuchung1",
				kat1,
				new Euro(24.4D)
		...
		final EinzelKategorie kat2 = db.findeOderErzeugeKategorie("MeineKategorie2");
		final StandardBuchung buchung2 = new StandardBuchung(
				new Datum(28, 3, 1970),
				"Testbuchung2",
				kat2,
				new Euro(28.3D)
	...
	public void testAddUmbuchung() {
		// Wichtig ist das neue Objekte 'Datum' verwendet werden, da diese nicht
		// geklont werden!
		...
		final Euro saldo1 = db.getRegisterSaldo("Konto1", new Datum(1, 1, 2008));
		assertTrue("Der Saldo sollte 52,70€ sein.",
				saldo1.compareTo(new Euro(52.7D)) == 0);
		final Euro saldo2 = db.getRegisterSaldo("Konto1", new Datum(2, 1, 2008));
		assertTrue("Der Saldo sollte 2,70€ sein.",
				saldo2.compareTo(new Euro(2.7D)) == 0);
		final Euro saldo3 = db.getRegisterSaldo("Konto2", new Datum(2, 1, 2008));
	...
	public void testRegisterVereinigen() {
		final EinzelKategorie kat1 = db.findeOderErzeugeKategorie("MeineKategorie1");
		final StandardBuchung buchung = new StandardBuchung(
				new Datum(1, 1, 1970),
				"Testbuchung3",
				kat1,
				new Euro(1.0D)
	...
	public void testGetAusgaben() {
		final AbstractZeitraum zeitraum = new MehrereJahre(1970, 2008);
		final Euro euro = db.getAusgaben(zeitraum, "Konto1");
	...
	public void testAusfuehrenAutoBuchungen() {
		...
		final Umbuchung umbuchung = db.getAutoUmbuchung(0);
